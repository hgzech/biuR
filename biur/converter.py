# AUTOGENERATED! DO NOT EDIT! File to edit: notebooks/02_converter.ipynb (unless otherwise specified).

__all__ = ['dict2ri', 'ri2dict', 'tuple2ri', 'none2ri', 'datetime2ri', 'dataframe_non_string_category_wrapper',
           'converter']
